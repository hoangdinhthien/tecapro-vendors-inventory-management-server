...
-- AddForeignKey
ALTER TABLE "SalesSummary" ADD CONSTRAINT "SalesSummary_productsProductId_fkey" FOREIGN KEY ("productsProductId") REFERENCES "Products"("productId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExpenseByCategory" ADD CONSTRAINT "ExpenseByCategory_expensesSummaryId_fkey" FOREIGN KEY ("expensesSummaryId") REFERENCES "ExpensesSummary"("expensesSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
